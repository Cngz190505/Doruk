...
function glBigCard(item, idx, cls) {
  ...
  return `
    <div class="gl-card-big ${cls}" onclick="openChartModal && openChartModal('${item.sym}USDT','${item.sym}')">
...
function glListRow(item, idx, cls) {
  ...
  return `
    <div class="gl-row ${cls}" onclick="openChartModal && openChartModal('${item.sym}USDT','${item.sym}')">
